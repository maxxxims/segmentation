...
if __name__ == '__main__':
    cfg = {
        'folder_path': r'images\0',   #7, 5, 6
        'relative_image_path': r'01. Reconstructed\02. Angular Decimation\01. x2',
        'image_name': 'im_00001.png',
        'image_tag': 'img0_500',
    }
    save_folder = Path('data')
    path_to_img = Path(r'C:\Users\user\Downloads') / 'im_00001.png'
    img = Image(path_to_img)
    #img.show()
    
    cfg = make_big_img(img, radius=300, slice_radius=150, cfg=cfg, path_to_save=save_folder / 'input') 
    img_gt = Image(Path(r'C:\Users\user\Downloads') / 'ann.png')
